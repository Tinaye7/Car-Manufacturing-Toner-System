...
?>
				...
				<table class="table table-hover table-striped table-bordered" id="table">
                    ...
                    <?php
                                           ...
                                           $sql = "SELECT orders.order_id,orders.client_name,product.product_code,product.product_name ,product.product_id, orders.order_date,cast(sum(order_item.quantity) as decimal(10,2)) as Total

                                           FROM orders 
                                         
                                         INNER JOIN order_item ON orders.order_id = order_item.order_id
                                         INNER JOIN product ON order_item.product_id = product.product_id where date(orders.order_date) between '$fdate' and '$tdate' group by product_id";
