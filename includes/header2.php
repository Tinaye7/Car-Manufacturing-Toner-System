...
<head>
	...
	<title>Supreme Panel Beaters</title>
...
<body>
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Supreme Panel Beaters</b></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
      ...
      <ul class="nav navbar-nav navbar-right" style="margin-right:60px">        
        ...
        <li class="dropdown" id="navProduct">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="glyphicon glyphicon-usd"></i> Products <span class="caret"></span></a>
	...
	<?php } ?>
 <?php  if(isset($_SESSION['userId']) && $_SESSION['userId']==1 || $_SESSION['userId']==4 || $_SESSION['userId']==8 || $_SESSION['userId']==5 || $_SESSION['userId']==6) { ?>
        <li id="navProduct"><a href="total.php"> <i class="glyphicon glyphicon-ruble"></i> Products Usage (Totals) </a></li> 
	<?php } ?>
	 <?php  if(isset($_SESSION['userId']) && $_SESSION['userId']==1 || $_SESSION['userId']==4 || $_SESSION['userId']==5 || $_SESSION['userId']==6 || $_SESSION['userId']==8) { ?>
        <li id="navProduct"><a href="usage.php"> <i class="glyphicon glyphicon-ruble"></i> Products Usage (Detailed)</a></li> 
	<?php } ?>
