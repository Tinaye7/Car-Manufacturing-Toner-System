...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(purchase == "") {
				$("#purchase").after('<p class="text-danger">iinitial Quantity field is required</p>');
				$('#purchase').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#purchase").find('.text-danger').remove();
				// success out for form 
				$("#purchase").closest('.form-group').addClass('has-success');	  	
			}	// /else
			if(quantity == "") {
			...
			if( productCode && productName &&iquantity &&purchase &&quantity  && categoryName && productStatus) {
	...
	if(productId) {
		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				// rate
				$("#editiQuantity").val(response.iquantity);
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					var iquantity = $("#editiQuantity").val();
					var purchase = $("#editpurchase").val();
					...
					if(purchase == "") {
						$("#editpurchase").after('<p class="text-danger">Purchase field is required</p>');
						$('#editpurchase').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#editpurchase").find('.text-danger').remove();
						// success out for form 
						$("#editpurchase").closest('.form-group').addClass('has-success');	  	
					}	// /else
