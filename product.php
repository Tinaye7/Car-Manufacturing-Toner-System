    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
			...
			<div class="form-group">
	        	<label for="iquantity" class="col-sm-3 control-label">Initial Quantity: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="float"  value="0" class="form-control" id="iquantity"  name="iquantity" autocomplete="off" >
				    </div>
	        </div> <!-- /form-group-->
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="float"  class="form-control" id="quantity" placeholder="Quantity" name="quantity" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	        	 

	        	     	        
			<div class="form-group">
	        	<label for="purchase" class="col-sm-3 control-label">Purchase Price: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="float"  class="form-control" id="purchase" placeholder="Purchase Price" name="purchase" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
					...
					<div class="form-group">
			        	<label for="editiQuantity" class="col-sm-3 control-label">Initial Quantity: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="float" value="0" class="form-control" id="editiQuantity"  name="editiQuantity" autocomplete="off" >
						    </div>
			        </div> <!-- /form-group-->
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="float" value="0" class="form-control" id="editQuantity" placeholder="Quantity" name="editQuantity" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	        	 
					<div class="form-group">
			        	<label for="editpurchase" class="col-sm-3 control-label">Purchase Price: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="float" value="0" class="form-control" id="editpurchase" placeholder="Purchase Price" name="editpurchase" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	
